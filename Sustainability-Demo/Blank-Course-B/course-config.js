...
window.COURSE_CONFIG = {
  ...
  courseId: "blank-course-b-draft",
  courseTitle: "Blank Course B",
  courseSubtitle: "A second prepared shell for a future training topic.",
  courseBlurb: "A second prepared shell for a future training topic. <em>Three topics, 10 minutes total.</em>",

...
window.COURSE_CONFIG = {
  ...
  courseId: "blank-course-c-draft",
  courseTitle: "Blank Course C",
  courseSubtitle: "A third prepared shell kept hidden until it is ready.",
  courseBlurb: "A third prepared shell kept hidden until it is ready. <em>Three topics, 10 minutes total.</em>",
